...
class MATERIAL_PT_dffMaterials(bpy.types.Panel):
    ...
    bl_label       = "Dragon Ball OnLine - Export Material"
...
class DFF_MT_ExportChoice(bpy.types.Menu):
    bl_label = "Dragon Ball OnLine"

    def draw(self, context):
        self.layout.operator(EXPORT_OT_dff.bl_idname,
                             text="Dragon Ball OnLine DFF (.dff)")
        self.layout.operator(EXPORT_OT_col.bl_idname,
                             text="Dragon Ball OnLine Collision (.col)")
            
        
#######################################################
def import_dff_func(self, context):
    self.layout.operator(IMPORT_OT_dff.bl_idname, text="Dragon Ball OnLine DFF (.dff)")

#######################################################
def export_dff_func(self, context):
    self.layout.menu("DFF_MT_ExportChoice", text="Dragon Ball OnLine")

#######################################################
class OBJECT_PT_dffObjects(bpy.types.Panel):

    bl_idname      = "OBJECT_PT_dffObjects"
    bl_label       = "Dragon Ball OnLine - Export Object"
    bl_space_type  = "PROPERTIES"
    bl_region_type = "WINDOW"
    bl_context     = "object"
